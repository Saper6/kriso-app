    ...
    <>
        ...
        <div className="container">
          <div className="row" id="keychain">
            <div className="col-12 col-lg-6 order-2 order-lg-1 align-self-end">
              <img className="img-fluid" src={image1} alt="img1"></img>
            </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-lg-6 align-self-start">
              <img className="img-fluid " src={image2} alt="img2"></img>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="content3" className="content">
        <div className="container">
          <div className="row">
            <div className="col-12 col-lg-6 order-2 order-lg-1 align-self-end">
              <img className="img-fluid item-img" src={image3} alt="img3"></img>
            </div>
            <div className="col-12 col-lg-6 order-1 order-lg-2 center">
      ...
      <div id="content4" className="content">
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-lg-6 align-self-start">
              <img className="img-fluid item-img" src={image4} alt="img4"></img>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="content5" className="content">
        <div className="container">
          <div className="row">
            <div className="col-12 col-lg-6 order-2 order-lg-1 align-self-end">
              <img className="img-fluid item-img" src={image5} alt="img5"></img>
            </div>
            <div className="col-12 col-lg-6 order-1 order-lg-2 center">
